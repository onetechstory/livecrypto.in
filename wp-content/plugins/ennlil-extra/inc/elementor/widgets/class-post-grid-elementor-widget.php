...
class ennlil_post_grid extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Ennlil Posts Grid', 'ennlil-extra' );
	}
    ...
    */
    private function layout_options() {
		...
		$this->add_responsive_control(
			'grid_img_height',
			[
				'label' =>esc_html__( 'Set Grid Image Height', 'ennlil-extra' ),
				...
				'selectors' => [
					'{{WRAPPER}} .news_block_Gridbox .news_blog_grid__Design .item.news-block-hover_Effect' => 'min-height: {{SIZE}}{{UNIT}};',
				],
			]
		);		
		...
		$this->add_responsive_control(
			'grid_padding',
			[
				'label' => esc_html__( 'Set Blog Grid Padding', 'kyrill' ),
				'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px','%'],
				'selectors' => [
					'{{WRAPPER}} .news_blog_grid__Design .news-block-design .item .post-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
        );
    ...
    */
    private function meta_options() {
		...
		$this->add_control(
            'blog_comment',
            [
                'label' => esc_html__('Display Post Comment Number', 'ennlil-extra'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'ennlil-extra'),
                'label_off' => esc_html__('No', 'ennlil-extra'),
                'default' => 'yes',
		...
		$this->add_control(
            'display_view',
            [
                'label' => esc_html__('Display Post View Number', 'ennlil-extra'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'ennlil-extra'),
                'label_off' => esc_html__('No', 'ennlil-extra'),
                'default' => 'no',
					...
					<div class="item news-block-hover_Effect" style="background-image:url(<?php echo esc_attr(esc_url(get_the_post_thumbnail_url(null, 'full'))); ?>)"> 
						<div class="news-postblock-content">
							...
							<ul class="single_blog_inner__Meta tab_post_list_single_Meta">
								...
								<?php if($display_blog_comment =='yes'): ?>
...
Plugin::instance()->widgets_manager->register_widget_type( new ennlil_post_grid() );